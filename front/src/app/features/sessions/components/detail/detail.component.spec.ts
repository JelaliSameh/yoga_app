...
import { FormBuilder } from '@angular/forms'; // Importer FormBuilder
...
describe('DetailComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      imports: [MatIconModule, MatCardModule], // Ajout des modules Material nécessaires
      providers: [
        FormBuilder,
  ...
  it('should call delete method when delete button is clicked', () => {
    component.isAdmin = true; // S'assurer que l'utilisateur est admin
    fixture.detectChanges(); 
  
    jest.spyOn(component, 'delete');
  
    const deleteButton = fixture.debugElement.query(By.css('[data-testid="delete-button"]'));
    expect(deleteButton).toBeTruthy(); // Vérifier que le bouton existe avant d’accéder à `nativeElement`
